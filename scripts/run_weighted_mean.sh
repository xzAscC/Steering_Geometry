...
#
# Usage:
#   ./scripts/run_weighted_mean.sh                                    # All concepts, default model
#   ./scripts/run_weighted_mean.sh -c honesty,toxicity                # Specific concepts
#   ./scripts/run_weighted_mean.sh -m Qwen/Qwen3.5-2B,google/gemma-2-2b  # Multiple models
#
# Output:
